...
<div class="row">
	...
	<div class="container">
		...
		<p class="radio-buttons">
			...
			<input type="radio" name="REL1" value="1" onclick="$('#married').show();$('#living-partner').hide();"/> Married </br>
			<input type="radio" name="REL1" value="2" onclick="$('#living-partner').show();$('#married').hide();" /> Living With partner </br>
			<input type="radio" name="REL1" value="3" onclick="$('#living-partner').hide();$('#married').hide();" /> Widowed </br>
			<input type="radio" name="REL1" value="4" onclick="$('#living-partner').hide();$('#married').hide();" /> Divorced </br>
			<input type="radio" name="REL1" value="5" onclick="$('#living-partner').hide();$('#married').hide();" /> Separated </br>
			<input type="radio" name="REL1" value="6" onclick="$('#living-partner').hide();$('#married').hide();" /> Never married/single </br>
			...
			<div class="cover" id="living-partner">
				<p class="mtop40 question-title">35b. How many years have you been living with your partner?</p>
			...
			<p class="mtop40 question-title">37. Are you a U.S. veteran? </p>
				...
				<p class="radio-buttons">
					<input type="radio" name="VET1" value="0" onclick="$('#37subs').hide()"/> No</br>
