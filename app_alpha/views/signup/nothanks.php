					...
					<p class="h4">Thank you for your time. We collect reasons why people don't want to participate so that we can improve our program. Please tell us your main reason, it'll be anonymous.</p>
						...
						<div class="container mtop40">
							...
							<?php echo form_open( $form_forward ); ?>
								...
								<input type="checkbox" name="reason_select[]" value="busy" required/> Busy/No time </br>
								<input type="checkbox" name="reason_select[]" value="confidential"/> Confidentiality concerns </br>
								<input type="checkbox" name="reason_select[]" value="no-research"/> Do not like research </br>
								<input type="checkbox" name="reason_select[]" value="no-disc-alc"/> Do not want to discuss alcohol </br>
								<input type="checkbox" name="reason_select[]" value="not-financial"/> Not enough financial incentive</br>
