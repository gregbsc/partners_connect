...
<?php echo form_open('screen'); ?>
	...
	<input type="radio" name="screen_1" value="yes" class="mright10" required=""> Yes <br>  <input type="radio" name="screen_1" value="no" class="mright10"> No <br>

	<h4 class="h4 mtop30">2. Are you currently serving in the military, including the National Guard or the Reserve?</h4>
	<input type="radio" name="screen_2" value="yes" class="mright10" required=""> Yes <br>  <input type="radio" name="screen_2" value="no" class="mright10"> No <br>

	<h4 class="h4 mtop30">3. Are you currently living with your partner?</h4>
	<input type="radio" name="screen_3" value="yes" class="mright10" required=""> Yes <br>  <input type="radio" name="screen_3" value="no" class="mright10"> No <br>
	...
	<input type="radio" name="screen_4" value="yes" class="mright10" required=""> Yes <br>  <input type="radio" name="screen_4" value="no" class="mright10"> No <br>

	<h4 class="h4 mtop30">5. Are you in a romantic relationship with your partner?</h4>
	<input type="radio" name="screen_5" value="yes" class="mright10" required=""> Yes <br>  <input type="radio" name="screen_5" value="no" class="mright10"> No <br>

	<h4 class="h4 mtop30">6. Do you have a computer that you can use in a private area?</h4>
	<input type="radio" name="screen_6" value="yes" class="mright10" required=""> Yes <br>  <input type="radio" name="screen_6" value="no" class="mright10"> No <br>

	<h4 class="h4 mtop30">7. Are you and your partner at least 18 years of age?</h4>
	<input type="radio" name="screen_7" value="yes" class="mright10" required=""> Yes <br>  <input type="radio" name="screen_7" value="no" class="mright10"> No <br>
