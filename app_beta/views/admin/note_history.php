<?php if(isset( $note_history )) : ?>
	...
	<?php foreach( $note_history as $note_history ) : ?>
		...
		<li> 
			<p> <strong> <?php echo $note_history->note_subject; ?> </strong> - <?php echo date('m-d-y', strtotime($note_history->post_time)); ?>  |  <span class="view-details"><strong>View details</strong></span> </p> 
