    ...
    <div class="form-group">
      ...
      <?php echo form_open('user/consent', $attributes); ?>
        ...
        <div class="mtop50">
          ...
          RAND is developing a program to help support military partners concerned about their service member’s alcohol use. The program’s goals are to help partners take care of their own needs and communicate with their loved ones in a positive manner that might help them reduce their drinking and seek help if needed. Your participation will help us adapt the program to make it more helpful. RAND is a non-profit organization that does research and this project is funded by the National Institutes of Health.</br> 
          ...
          1. If we need to protect you or others from imminent harm. An example of this is if you want to hurt yourself or others. In that case, we will give information about you to others (e.g., 911, research staff) in order to protect you or others from harm. </br>
          2. If you tell us about the abuse of a child or of an elderly person. In that case, we may report it to the authorities.</br>
        ...
        <input type="text" name="person_name" placeholder="Initials Here" required=""/> </br>
